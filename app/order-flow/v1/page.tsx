...
// ─── Main Page ──────────────────────────────────────────────────────
export default function OrderFlowV1() {
  ...
  return (
    <div className="relative mx-auto flex h-dvh max-w-[430px] flex-col overflow-hidden bg-background">
      ...
      {/* ─── Content ────────────────────────────────────────────── */}
      <main className="no-scrollbar flex-1 overflow-y-auto px-5 pt-4 pb-[165px]">
        {/* Order Card */}
        <Card className="p-4">
          {/* Amount */}
        ...
        <button
          ...
          className="mt-4 mx-auto flex items-center gap-1.5 text-[14px] font-medium text-muted-foreground active:opacity-70 transition-opacity"
        >
          Advanced
          <motion.div
        ...
        <AnimatePresence>
          {showAdvanced && (
            ...
            >
              <Card className="mt-3 p-3.5 flex items-center gap-3">
                <Checkbox
                  checked={stopLoss}
