...
const rows: AllocationRow[] = [
  ...
  { name: "Small Cap", subtitle: "300M – 2B",   color: "bg-neutral-300", invested: 1_630,  current: 1_780,  xirr: 8.6 },
  { name: "Micro Cap", subtitle: "50M – 300M",  color: "bg-neutral-200", invested: 1_630,  current: 1_780,  xirr: 8.6 },
  { name: "Nano Cap",  subtitle: "<50M",        color: "bg-neutral-100", invested: 1_630,  current: 1_780,  xirr: 8.6 },
];
